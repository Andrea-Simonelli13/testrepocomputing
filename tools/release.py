...
from testrepocomputing import TESTREPOCOMPUTING_DOCS, TESTREPOCOMPUTING_SRC

_VERSION_FILE_PATH = TESTREPOCOMPUTING_SRC / "_version.py"
_RELEASE_NOTES_PATH = TESTREPOCOMPUTING_DOCS / "release_notes.rst"
_ENCODING = "utf-8"
